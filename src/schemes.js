...
import { toNearestGrade } from "./gradeUtils.js";
...
const defenseRelatedWork = new Criterion("related", { en: "Appreciation of related work", de: "Beschreibung verwandter Arbeiten" }, defense);
...
const aggregateWritten = new Criterion("written", { en: "Written grade", de: "Schriftlich" });
const aggregateOral = new Criterion("oral", { en: "Defense grade", de: "Mündlich" });

class LMUThesisScheme extends Scheme {
    constructor() {
        super(
            { "en": "Thesis", "de": "Abschlussarbeit" },
            {
    ...
    aggregateGroupGrades(groupGrades) {
        return {
            [aggregateWritten.key]: toNearestGrade(this.measure.aggregateChoquet(groupGrades)),
            [aggregateOral.key]: toNearestGrade(groupGrades[defense.key])
        };
    }
}
